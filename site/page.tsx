...
const operatingPrinciples=[
 ["Every Day Is a School Day","Every kitchen, classroom, visit, event, and conversation is a chance to learn."],
 ["Provide Clear Direction","You should understand the goal, the standard, and what success looks like before working independently."],
 ["Inspect What You Expect","We verify safety, quality, accuracy, and professional habits through observation, coaching, records, and follow-through."],
 ["Students Advance by Demonstrating Competency","Progress is earned by showing that you can apply knowledge, skill, behavior, and judgment consistently."],
 ["Experiences Provide Evidence. Competencies Determine Progression.","A lab, event, or placement creates evidence of learning. The evidence—not simply participation—determines the next level of responsibility."],
 ["Learning Before Labor","Student learning always comes before production. You are here to build skill, not simply complete work for someone else."],
 ["Preparation Before Independence","Responsibility increases after readiness has been demonstrated and the right supervision and support are in place."],
 ["Quality Before Quantity","We would rather complete a smaller amount of work safely and well than expand beyond what we can support."],
 ["Build Leaders, Not Just Cooks","Technical skill matters, and so do communication, teamwork, decision-making, coaching, and responsibility."],
 ["Travel Rights Are Earned","Representing the pathway beyond the classroom requires demonstrated readiness, professionalism, and responsibility."]
] as const;
...
${response.exit || "No response entered."}`;
 ...
 return <div className="shell">
  ...
  {view==="mission"&&<section className="page missionPage"><small>WHY WE WORK THIS WAY</small><h1>Our Mission &amp; Commitments</h1><p className="lead">The GCSD Culinary Pathway develops confident, reflective, professionally minded students through authentic culinary experiences. We prepare students for meaningful careers, lifelong learning, and responsible leadership by increasing responsibility as competency is demonstrated.</p><section className="missionStatement"><div><small>OUR MISSION</small><h2>Learn with purpose. Grow through practice. Earn greater responsibility.</h2><p>Culinary skill grows through repeated, thoughtful practice. The goal is not simply to finish a recipe. The goal is to become safer, more capable, more responsible, and more independent.</p></div><div><small>OUR SHARED COMMITMENT</small><h2>Prepare. Verify. Improve.</h2><ul><li><b>Prepare</b> your station and your thinking.</li><li><b>Verify</b> safety, quality, and accuracy.</li><li><b>Improve</b> through feedback and reflection.</li></ul></div></section><section className="principles"><small>HOW THE PATHWAY OPERATES</small><h2>Ten operating principles</h2><p>These principles guide students, instructors, and partners. They explain how support, responsibility, and opportunity grow across the pathway.</p><div>{operatingPrinciples.map(([title,explanation],i)=><article key={title}><span>{i+1}</span><div><h3>{title}</h3><p>{explanation}</p></div></article>)}</div></section><aside className="closingCommitment"><small>CLOSING COMMITMENT</small><h2>Prepare Students. Verify Competence. Increase Responsibility. Support the Transition to Professional Practice.</h2></aside></section>}
